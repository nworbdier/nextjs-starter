    ...
    <footer className="border-t mt-auto">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex justify-between">
          <div className="max-w-xs">
            <h3 className="font-semibold mb-3">RWB BETS</h3>
            <p className="text-sm text-muted-foreground mr-5">
              Your trusted platform for sports betting projections and analysis.
            </p>
          </div>
          {user && (
            <div>
      ...
      <div className="border-t">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 text-center text-sm text-muted-foreground">
          <h1 className="text-sm text-center">© 2025 RWB BETS</h1>
